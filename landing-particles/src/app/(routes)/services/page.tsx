    ...
    return (
        <>
            ...
            <div className="grid items-center justify-center h-screen max-w-5xl gap-6 mx-auto md:grid-cols-2">
                <div className="max-w-[300px] mt-20 md:mt-0">
                    ...
                    <p className="mb-3 text-xl text-gray-300">Ofrezco servicios de desarrollo web full stack especializados en la creación de sitios web y aplicaciones atractivas y funcionales. Utilizando las últimas tecnologías, como HTML, CSS, JavaScript, entre otros, diseño interfaces de usuario intuitivas y responsivas que reflejan la identidad de marca de mis clientes y mejoran su presencia en línea.</p>
